...
CODE:
    ...
    les deux sans problèmes tant que vous ne les mélangez pas.

POINTS IMPORTANTS À RETENIR:
    Pour définir une chaîne de caractère, il faut utiliser le même type de
    guillemet en ouverture et fermeture.
"""